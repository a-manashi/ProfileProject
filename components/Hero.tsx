...
export function Hero() {
  return (
    ...
    >
      ...
      <Container className="relative grid items-center gap-12 py-20 md:py-28 lg:grid-cols-[minmax(0,1.1fr)_minmax(0,0.9fr)] lg:gap-16 lg:py-32">
        <div>
          <p className="hero-in font-mono text-[11px] uppercase tracking-[0.22em] text-accent">
            {hero.eyebrow}
          </p>
          <h1
            id="hero-name"
